# See https://github.com/divnix/digga/blob/main/src/importers.nix
# https://raw.githubusercontent.com/divnix/digga/5d159417c63089c674cd51bed0f1b242ee840375/src/importers.nix
{ lib }:
let
  flattenTree =
    /*
